...
\bibitem{placeholder_shannon_properties} C. E. Shannon, \emph{A Mathematical Theory of Communication}, Bell System Technical Journal, 1948. %(Or cite info theory textbook like Cover & Thomas).
...
\bibitem{placeholder_cover_thomas} T. M. Cover, J. A. Thomas, \emph{Elements of Information Theory}, Wiley, 2006.
...
\bibitem{placeholder_repo} [Your Name/Link], \emph{"entrolibrium" repository}, GitHub, 2025. %(Optional, cite the repo).
\end{thebibliography}
